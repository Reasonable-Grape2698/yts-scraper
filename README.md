...
|`-l` or `--language`                     |Specify language  (Default en , find options [here](https://yts.mx/browse-movies/0/all/all/0/latest/0/foreign), note the code shown ie, [fr])            |
|`-u` or `--date-up-min`                  |Starting upload date DD/MM/YYYY format (e.g., 25/12/2024)                                                                                                |
|`-d` or `--downloaded_movies`                  |CSV, JSON, or line seperated movie hash list                                                                                           |
